...
export default function RegistrarGastoPage() {
 ...
 {/* Main Container */}
 <div className="w-full max-w-4xl bg-surface rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[600px] border border-border ">
 
 {/* Left Column: Primary Inputs */}
 <div className="flex-1 p-6 sm:p-8 flex flex-col gap-6 border-r border-border transition-colors">
 
 {/* Header */}
 <div className="flex justify-between items-start">
 <div>
 <h1 className="text-3xl font-bold tracking-tight text-text-main">Registrar Gasto</h1>
 <p className="text-primary text-sm mt-1 font-medium">Ingresa los detalles de tu nuevo movimiento</p>
 </div>
 <button 
 onClick={() => router.back()}
 ...
 <div className="w-full md:w-[320px] bg-background p-6 sm:p-8 flex flex-col gap-6 justify-between border-l border-border transition-colors">
 
 <div className="flex flex-col gap-6">
 <h2 className="text-lg font-semibold text-text-main ">Opciones</h2>
 ...
 <div className="w-8 h-8 rounded-full bg-surface flex items-center justify-center text-text-sub group-hover:text-primary transition-colors shadow-sm">
 ...
 <select defaultValue="Mensual" className="w-full text-sm bg-surface border border-border rounded-lg py-2 px-3 text-text-main focus:ring-1 focus:ring-primary focus:border-primary focus:outline-none cursor-pointer">
 ...
 <div className="border-2 border-dashed border-border bg-surface rounded-xl p-4 flex flex-col items-center justify-center text-center cursor-pointer hover:border-primary hover:bg-primary/5 transition-all group">
